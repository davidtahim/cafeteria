					...
					<div class="container-fluid p-0">
						...
						<div class="row">
							...
							<div class="mb-3 col-6">
								...
								<input type="email" class="form-control" name="email" id="email" placeholder="coloque o e-mail no formato abc@mail.com" />
						...
						<div class="row">
							<div class="mb-3 col-4">
								...
								<input type="text" class="form-control" name="telefone" id="telefone" placeholder="(99)9 9999-9999" />

							</div>
							<div class="mb-3 col-4">
								<label for="cpfcnpj" class="form-label">CPF/CNPJ</label>
								<input type="text" class="form-control" name="cpfcnpj" id="cpfcnpj" placeholder="Somente Números" />

							</div>
							<div class="mb-3 col-4">
								<label for="cep" class="form-label">CEP</label>
								<input type="text" class="form-control" name="cep" id="cep" maxlength="8" onkeyup="viaCEP()" placeholder="Somente Números" />
						...
						<div class="row">
							<div class="mb-3 col-4">
								...
								<input type="text" class="form-control" name="logradouro" id="logradouro" placeholder="Digite a rua" />

							</div>
							<div class="mb-3 col-3">
								<label for="numero" class="form-label">Nº</label>
								<input type="text" class="form-control" name="numero" id="numero" placeholder="Número da casa" />
							</div>
							...
							<div class="mb-3 col-3">
								...
								<input type="text" class="form-control" name="bairro" id="bairro" placeholder="Qual o bairro " />
							</div>
							<div class="row">
								<div class="mb-3 col-4">
								...
								?>
									<tr>
										...
										<td>
											...
											<button type="button" class="btn btn-warning btn-lg" data-bs-toggle="modal" data-bs-target="#modaleditar" data-id='<?php echo $id ?>'>
